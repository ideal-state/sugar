...
import team.idealstate.sugar.bytecode.api.member.JavaMethod;
import team.idealstate.sugar.bytecode.api.member.JavaParameter;
...
class InternalJavaMethod implements JavaMethod {
    ...
    InternalJavaMethod(@NotNull JavaClass declaringClass, int access, @NotNull String name, int parameterCount, @NotNull String returnTypeName, String[] exceptionTypeNames) {
    ...
    public JavaClass[] getExceptionTypes() {
        return exceptionTypeNames == null ? new JavaClass[0] :
    ...
    static class Visitor extends MethodVisitor {
        ...
        Visitor(int api, MethodVisitor methodVisitor, @NotNull InternalJavaMethod internalJavaMethod) {
        ...
        public void visitLocalVariable(String name, String descriptor, String signature, Label start, Label end, int index) {
            ...
            if (isParameterIndex(recalculatedIndex)) {
                InternalJavaParameter internalJavaParameter =
                        parameterMap.computeIfAbsent(index, i -> new InternalJavaParameter(internalJavaMethod));
        ...
        public AnnotationVisitor visitAnnotationDefault() {
            ...
            annotationVisitor = new AnnotationDefaultVisitor(api, annotationVisitor, internalJavaMethod);
            return annotationVisitor;
        }
        ...
        private static class AnnotationDefaultVisitor extends InternalJavaAnnotation.AbstractVisitor {
            ...
            public AnnotationDefaultVisitor(int api, AnnotationVisitor annotationVisitor, @NotNull InternalJavaMethod internalJavaMethod) {
