...
package team.idealstate.sugar.bytecode.exception;
...
public class BytecodeParsingException extends BytecodeException {
    ...
    protected BytecodeParsingException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
