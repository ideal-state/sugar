...
public class SugarException extends RuntimeException {
    ...
    private static final long serialVersionUID = -3956816622465386168L;
    ...
    protected SugarException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
