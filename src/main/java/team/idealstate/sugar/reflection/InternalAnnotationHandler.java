...
class InternalAnnotationHandler implements ReflectionInvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        CHECK_RETURN_TYPE: if (!returnType.isAssignableFrom(valueType)) {
            THROW_EX: if (returnType.isArray() && valueType.isArray()) {
            ...
            throw new ReflectionException("Return type of method " + methodName + " must be assignable from mappings value.");
        }
