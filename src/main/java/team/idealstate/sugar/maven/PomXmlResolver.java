...
public class PomXmlResolver extends DefaultHandler {
    ...
    public static final Set<Integer> OPTIONAL_INDEX_DEPENDENCY_ELEMENT = Collections.unmodifiableSet(
            new HashSet<>(Arrays.asList(INDEX_DEPENDENCY_EXTENSION, INDEX_DEPENDENCY_CLASSIFIER)));
    ...
    private Dependency makeDependency() {
        ...
        for (int i = 0; i < builder.length; i++) {
            ...
            if (content == null) {
                ...
                throw new MavenException(String.format("invalid dependency id %s", Arrays.toString(builder)));
            }
            joiner.add(content);
        }
