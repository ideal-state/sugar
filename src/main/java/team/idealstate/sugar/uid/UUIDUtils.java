...
package team.idealstate.sugar.uid;
...
public abstract class UUIDUtils {
    ...
    public static UUID binaryToUUID(byte[] binary, boolean swapFlag) {
        ValidateUtils.notNull(binary, "binary must not be null");
        ValidateUtils.isTrue(binary.length == BIN_LEN, "binary's length must be equal to " + BIN_LEN);
        if (swapFlag) {
    ...
    public static byte[] uuidToBinary(String uuid) {
        return uuidToBinary(UUID.fromString(uuid), false);
    }

    public static byte[] uuidToBinary(String uuid, boolean swapFlag) {
    ...
    public static byte[] uuidToBinary(UUID uuid, boolean swapFlag) {
        ValidateUtils.notNull(uuid, "uuid must not be null");
